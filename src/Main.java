...
public class Main extends Application {
    ...
    private int questionCounter, currentPlayer, difficulty;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FileInputStream imageOfADice = new FileInputStream("Images/White_Dice.png");
        FileInputStream background = new FileInputStream("Images/cool-background.jpg");
